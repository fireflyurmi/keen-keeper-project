...
export default function FriendsCard({ friend }) {
  ...
  return (
    <Link href={`/friend/${friend.id}`}>
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300 cursor-pointer">
